 ...
 *   IDENTITY_TO .. 1          folders + model                 (transition HOLD .. 1)
 *
 * `transition` is the value every star, model and folder constant was tuned
 ...
 * third of the ring is still orbiting on screen, and neither the folders nor
 * the model have started. Those few stars are the identity scene's sky.
 *
...
/** The Scene 1 -> folders transition value, paused through identity. */
